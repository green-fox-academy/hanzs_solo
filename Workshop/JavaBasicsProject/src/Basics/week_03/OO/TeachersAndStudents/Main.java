package Basics.week_03.OO.TeachersAndStudents;
...
public class Main {
  ...
  public static void main(String[] args) {
    Teacher csabaBacsi = new Teacher();
    Student sanyika = new Student();

    sanyika.question(csabaBacsi);
    csabaBacsi.teach(sanyika);
  }
}
