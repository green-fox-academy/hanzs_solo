...
public class WebshopRepository {
  ...
  public WebshopRepository(){
    ...
    itemsInitial.add(new Item("bread", "delicious white bread", 2, 6));
    itemsInitial.add(new Item("nike shoes", "colorful nike shoes", 80, 1));
    itemsInitial.add(new Item("coffee beans", "green coffee beans from Kenya", 30, 7));
    itemsInitial.add(new Item("cuban cigar", "authentic cuban cigar", 50, 17));
    itemsInitial.add(new Item("bottle of water", "regular mineral water", 1, 12));
    itemsInitial.add(new Item("alarm clock", "a brand new alarm clock", 4, 1));
    itemsInitial.add(new Item("cataflam", "a strong painkiller", 6, 5));
    itemsInitial.add(new Item("chewing gum", "chewing gum for kids", 1, 8));
    itemsInitial.add(new Item("condoms x3", "chewing gum not for kids", 3, 16));
    itemsInitial.add(new Item("hoodie", "a green hoodie with a fox", 12, 4));
